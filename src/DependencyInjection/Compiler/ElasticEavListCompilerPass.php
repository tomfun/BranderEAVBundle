...
use Brander\Bundle\EAVBundle\Model\Elastica\EavList;
    ...
    CompilerPassInterface
{
    ...
    public function makeElasticaList(ContainerBuilder $container, $classMap)
    {
        foreach ($classMap as $entityConfig) {
            ...
            $finder = $container->getDefinition($finder);

            $indexDef->setArguments([$finder]);
            ...
            $finder = $container->setDefinition($indexId, $indexDef);
        }
    }
