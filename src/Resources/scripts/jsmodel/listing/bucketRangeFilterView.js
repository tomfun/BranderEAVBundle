define([
    ...
    return BaseView.extend({
        ...
        "unitFormat": function(key, view_key) {
            return this.unit;
        },

        "formatViewNumber": function (number) {
            return __.numberFormat(number, Math.abs(number) > 1 ? 0 : 3, '.', ' ');
        },

        "formatViewDate": function (momentObj) {
